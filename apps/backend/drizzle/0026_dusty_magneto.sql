...
ALTER TABLE "material_and_supply" ADD COLUMN "purchase_quantity" numeric(12, 2) NOT NULL;--> statement-breakpoint
ALTER TABLE "material_and_supply" ADD COLUMN "supplier_url" text;--> statement-breakpoint

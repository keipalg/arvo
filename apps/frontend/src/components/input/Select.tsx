...
const Select = ({
    ...
    return (
        <div className="flex flex-col">
            ...
            <select
                className={`border rounded-xl focus:border-arvo-blue-100 px-2.5 py-2.5 bg-arvo-white-0 border-arvo-black-5 disabled:bg-arvo-black-5 cursor-not-allowed outline-none`}
                name={name}
                value={value}
                onChange={onChange}
                disabled={disabled}
